...
function Navbar() {
  return (
    <div className="hidden div-navbar">
      <nav className="navbar navbar-expand-lg navbar-light bg-light div-navbar d-flex">
        <div className="container-fluid">
          ...
          <ul className="navbar-nav mx-auto mb-2 mb-lg-0 nav-ul d-flex">
            <li class="nav-item">
          ...
          <form className="d-flex nav-form">
            ...
            >
              <button className="btn btn-position" type="button">
                <svg
              ...
              <input
                className="form-control width-reset "
                type="search"
                aria-label="Search"
                placeholder="Search"
              />
          ...
          <ul className="navbar-nav nav-form-ul-position mr-auto mb-2 mb-lg-0">
